...
export const mcpTools: MCPTool[] = [
  {
    name: 'list_todos',
    description: 'Get all todo items. Returns an array of todos with their details.',
    inputSchema: {
      type: 'object',
      properties: {
        filter: {
  ...
  {
    name: 'create_todo',
    description: 'Create a new todo item. Returns the created todo with its generated ID.',
    inputSchema: {
      type: 'object',
      properties: {
        title: {
    ...
    execute: async (args: { title: string; description?: string; tags?: string[] }) => {
      const now = Date.now();
      const todo: Todo = {
        id: nanoid(),
        title: args.title,
  ...
  {
    name: 'update_todo',
    description: 'Update an existing todo item. Can modify title, description, completion status, or tags.',
    inputSchema: {
      type: 'object',
      properties: {
        id: {
  ...
  {
    name: 'toggle_todo',
    description: 'Toggle the completion status of a todo item. Returns the updated todo.',
    inputSchema: {
      type: 'object',
      properties: {
        id: {
  ...
  
  {
    ...
    description: 'Delete all completed todo items. Returns the number of items deleted.',
    inputSchema: {
      type: 'object',
      properties: {},
    },
 ...
 */
export function listTools(): Array<{ name: string; description: string; inputSchema: any }> {
